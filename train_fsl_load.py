...
if __name__=="__main__":
    ...
    parser.add_argument("--model_checkpoint_file", help="Path to model checkpoint", type=str, required=True)
    ...
    experiment.model.load_from_checkpoint(args.model_checkpoint_file)
